...
<body>
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="#">
                            ...
                            <span class="text nav-text">Reading List</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-link">
                        <a href="#">
                            ...
                            <span class="text nav-text">Book Reviews</span>
                        </a>
                    </li>
    ...
    <section class="home">
        <div class="text" style = "text-align:center;">User Dashboard</div>

        <!--Contents-->

        <h1 class = "" style = "margin-left:20px;">USER</h1>
    </section>
